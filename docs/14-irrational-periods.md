# Irrational numbers as 'periods' in discrete sequences

*Originally posted on [math.stackexchange.com](https://math.stackexchange.com/questions/4911385/irrational-numbers-as-periods-in-discrete-sequences-based-on-complex-exponenti) (question 4911385).*
...
[![mod_13_basic_log_wheel](https://i.sstatic.net/GsCyncRQ.png)](https://i.sstatic.net/GsCyncRQ.png)

## $M=1$ $M_c=13$ $T_o=13$

[![enter image description here](https://i.sstatic.net/fzlwPBz6.png)](https://i.sstatic.net/fzlwPBz6.png)

## $M=1$ $T_o=M_c=3$

[![enter image description here](https://i.sstatic.net/vN05u4o7.png)](https://i.sstatic.net/vN05u4o7.png)

## $M=1$ with big $T_o=M_c=10^5$

[![enter image description here](https://i.sstatic.net/4hzOpNJL.png)](https://i.sstatic.net/4hzOpNJL.png)

Evolves to:
[![enter image description here](https://i.sstatic.net/vz2CDSo7.png)](https://i.sstatic.net/vz2CDSo7.png)
...
[![enter image description here](https://i.sstatic.net/nS94qJjP.png)](https://i.sstatic.net/nS94qJjP.png)

Evolves to:
[![enter image description here](https://i.sstatic.net/XWFqLAFc.png)](https://i.sstatic.net/XWFqLAFc.png)

[![enter image description here](https://i.sstatic.net/828Dol6T.png)](https://i.sstatic.net/828Dol6T.png)

[![enter image description here](https://i.sstatic.net/53s9Dy5H.png)](https://i.sstatic.net/53s9Dy5H.png)

## Other irrational example $T_o=\sqrt{2}$ and $M_c=16$

[![enter image description here](https://i.sstatic.net/eAHXACOv.png)](https://i.sstatic.net/eAHXACOv.png)
