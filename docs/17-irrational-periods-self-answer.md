# Irrational periods — self-answer

*Answer by **fbatrouni** on [math.stackexchange.com](https://math.stackexchange.com/a/4912797) — score 5. Parent question: 4911385.*
...
[![enter image description here](https://i.sstatic.net/x2MCIeiI.png)](https://i.sstatic.net/x2MCIeiI.png)
...
[![enter image description here](https://i.sstatic.net/MEtQTspB.png)](https://i.sstatic.net/MEtQTspB.png)
...
[![enter image description here](https://i.sstatic.net/65Ne4yfB.png)](https://i.sstatic.net/65Ne4yfB.png)

It looks like it works. Looking closely we see :

[![enter image description here](https://i.sstatic.net/ftgxbL6t.png)](https://i.sstatic.net/ftgxbL6t.png)

## Here  $M=1$ $M_c=p_o=2584$ and $T_o=\frac{2584}{1597}$  in hsv from the beginning

[![enter image description here](https://i.sstatic.net/KXbOPmGy.png)](https://i.sstatic.net/KXbOPmGy.png)
...
[https://www.youtube.com/watch?v=Gdy1u4lsjDw](https://www.youtube.com/watch?v=Gdy1u4lsjDw)

# Almost Periodic Functions

The comment from Gerry has really interesting reads on for example:
[https://en.wikipedia.org/wiki/Almost_periodic_function](https://en.wikipedia.org/wiki/Almost_periodic_function)
...
[https://oeis.org/wiki/Index_to_OEIS:_Section_Ce#cell](https://oeis.org/wiki/Index_to_OEIS:_Section_Ce#cell)
...
[https://mathworld.wolfram.com/SierpinskiSieve.html](https://mathworld.wolfram.com/SierpinskiSieve.html)
...
[https://youtube.com/shorts/A7xMJ639gAw?si=vr9JzHWUt7zdFeHt](https://youtube.com/shorts/A7xMJ639gAw?si=vr9JzHWUt7zdFeHt)

- Draw the circle of fifths as an HSV colored wheel with M=12 slots using M colors and add M labels for the notes. radius=1
...
- Randomly choose a point inside a unitary circle - Express it as a complex number
...
- Randomly choose between this three notes $(A_b,E,C) or (7,11,3) $ note in the circle of fifths
...
- Draw a line between $Z_o$ and $Z_{note}$

- Find the mid point between $Z_o$ and $Z_{note}$ and call it $Z_{\frac{1}{2}}$

- Set $Z_o=Z_{\frac{1}{2}}$ and repeat $N_{iter}$ times from step 2 using this new value of $Z_o$ in step 3

[![enter image description here](https://i.sstatic.net/p8psi9fg.png)](https://i.sstatic.net/p8psi9fg.png)

[![enter image description here](https://i.sstatic.net/Zbn5ltmS.png)](https://i.sstatic.net/Zbn5ltmS.png)

## Computational Complexity and irrational numbers

Here in MS I found this interesting context :

[https://math.stackexchange.com/q/307157](https://math.stackexchange.com/q/307157)
...
[![enter image description here](https://i.sstatic.net/OBYZfG18.png)](https://i.sstatic.net/OBYZfG18.png)
